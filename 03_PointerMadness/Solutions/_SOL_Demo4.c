...
int main()
{
	char * string1 = "Hello";		// String literal is not const but it is undefined behaviour to change the contents
	char string2[] = "World";		// String literal assigned to char array fills the individual elements with the individual chars -> not const
